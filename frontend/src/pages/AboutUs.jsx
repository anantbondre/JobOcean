        ...
        <div className="container mb-md-0 mt-5">
          ...
          <div className="row mt-lg-3 d-flex align-items-center justify-content-center">
            <div className="col-lg-12 col-md-12 mt-3 aboutus-main-card">
              <AboutItem
                q="Welcome to JobOcean!"
                a="At JobOcean, we make connections as easy to explore as the places around us. Our platform bridges the gap between people and locations, offering users the ability to view profiles and interact with their associated places on a dynamic map. Whether you're looking for a business, a professional, or simply exploring new connections, JobOcean brings the world to your fingertips—one profile, one location at a time. Through detailed profiles and map-based exploration, we provide a unique and engaging way to discover people and places worldwide."
              />
